export const CORE_EXERCISES = [
  ...
  },
  {
    ...
    equipment: "自重",
    subTarget: "腹直肌 (上腹/下腹)",
    target: "全腹直肌抗下坠、深层腹横肌",
    secondaryMuscles: ["核心协同稳定肌群"],
    aliases: ["龙旗 (李小龙传世核心硬核动作)","Dragon Flag","龙旗","李小龙龙旗"],
    gifUrl: "./exercises/dragon-flag.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "双手抓紧卧推凳，仅以上背为支点将全身笔直向上挺起并平缓下放。",
    tags: ["自重","腹直肌 (上腹/下腹)","精选变式"],
    tips: {
  ...
  {
    id: "ex-windshield-wiper",
    name: "悬垂雨刷摆腿 (全向抗旋)",
    englishName: "Hanging Windshield Wiper",
    category: "核心",
    equipment: "自重",
    subTarget: "腹斜肌 (侧腹)",
    target: "腹内外斜肌、前锯肌、握力与肩带稳定",
    secondaryMuscles: ["核心协同稳定肌群"],
    aliases: ["悬垂雨刷摆腿 (全向抗旋)","Hanging Windshield Wiper","悬垂雨刷","雨刮器摆腿","Windshield Wiper"],
    gifUrl: "./exercises/hanging-windshield-wiper.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "悬吊在单杠上双腿高举至天花板，左右往复如雨刮器摆动，强力雕刻侧腹人鱼线。",
    tags: ["自重","腹斜肌 (侧腹)","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-swiss-ball-rollout",
    name: "瑞士球/瑜伽球推球卷腹",
    englishName: "Swiss Ball Rollout",
    category: "核心",
    equipment: "自重",
    subTarget: "深层核心 (抗旋/抗伸)",
    target: "腹横肌抗伸展、胸腹动力链",
    secondaryMuscles: ["核心协同稳定肌群"],
    aliases: ["瑞士球/瑜伽球推球卷腹","Swiss Ball Rollout","瑜伽球推球","瑞士球滚动"],
    gifUrl: "./exercises/swiss-ball-rollout.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "双膝跪地推滚瑞士球向前延伸，比健腹轮更温和且弧线饱满，保护下背腰椎。",
    tags: ["自重","深层核心 (抗旋/抗伸)","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
      "peak": "向心终点充分挤压目标肌群1-2秒，感受峰值做工肌电收缩。",
  ...
  {
    id: "ex-decline-weighted-crunch",
    name: "下斜板负重卷腹 (Decline Crunch)",
    englishName: "Decline Weighted Crunch",
    category: "核心",
    equipment: "哑铃",
    subTarget: "腹直肌 (上腹/下腹)",
    target: "腹直肌上段高负荷抗阻做工",
    secondaryMuscles: ["核心协同稳定肌群"],
    aliases: ["下斜板负重卷腹 (Decline Crunch)","Decline Weighted Crunch","下斜卷腹","仰卧板卷腹","Decline Crunch"],
    gifUrl: "./exercises/decline-push-up.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "双脚卡在下斜板上双手持杠铃片于胸前卷动，打破自重卷腹的平台期。",
    tags: ["哑铃","腹直肌 (上腹/下腹)","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
      "peak": "向心终点充分挤压目标肌群1-2秒，感受峰值做工肌电收缩。",
  ...
  {
    id: "ex-cable-seated-twist",
    name: "绳索坐姿水平扭转转体",
    englishName: "Seated Cable Twist",
    category: "核心",
    equipment: "绳索",
    subTarget: "腹斜肌 (侧腹)",
    target: "腹外斜肌水平旋转向心爆发力",
    secondaryMuscles: ["核心协同稳定肌群"],
    aliases: ["绳索坐姿水平扭转转体","Seated Cable Twist","绳索转体","坐姿转体","Cable Twist"],
    gifUrl: "./exercises/russian-twist.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "坐姿固定下半身骨盆，利用双滑轮牵引阻力旋转躯干，专攻公狗腰与旋转爆发力。",
    tags: ["绳索","腹斜肌 (侧腹)","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-floor-windshield-wiper",
    name: "仰卧地板雨刷摆腿",
    englishName: "Floor Windshield Wiper",
    category: "核心",
    equipment: "自重",
    subTarget: "腹斜肌 (侧腹)",
    target: "腹斜肌、腰椎灵活性",
    secondaryMuscles: ["核心协同稳定肌群"],
    aliases: ["仰卧地板雨刷摆腿","Floor Windshield Wiper","仰卧雨刷","地板雨刮器","Floor Wiper"],
    gifUrl: "./exercises/half-wipers.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "平躺于瑜伽垫上双臂撑平，双腿垂直向上后向左右两侧慢速摆动。",
    tags: ["自重","腹斜肌 (侧腹)","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-bear-crawl",
    name: "熊爬对抗前进 (Bear Crawl)",
    englishName: "Bear Crawl",
    category: "核心",
    equipment: "自重",
    subTarget: "深层核心 (抗旋/抗伸)",
    target: "深层腹内压、对角线筋膜链、肩胛动态支撑",
    secondaryMuscles: ["核心协同稳定肌群"],
    aliases: ["熊爬对抗前进 (Bear Crawl)","Bear Crawl","熊爬","熊式爬行"],
    gifUrl: "./exercises/bear-crawl.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "膝盖离地悬空低姿爬行，强力整合全身交叉动力链与抗旋转核心。",
    tags: ["自重","深层核心 (抗旋/抗伸)","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  },
  {
    id: "ex-v-up-crunch",
    name: "V字两头起折叠卷腹 (V-Up)",
    englishName: "V-Up Crunch",
    category: "核心",
    equipment: "自重",
    subTarget: "腹直肌 (上腹/下腹)",
    target: "腹直肌上下段同步极限向心缩短",
    secondaryMuscles: ["核心协同稳定肌群"],
    aliases: ["V字两头起折叠卷腹 (V-Up)","V-Up Crunch","V字卷腹","折叠卷腹","V-Up","两头起卷腹"],
    gifUrl: "./exercises/v-up.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "仰卧位双手与双脚同时向上抬起并在最高点触碰，极致压缩腹肌。",
    tags: ["自重","腹直肌 (上腹/下腹)","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-crab-walk",
    name: "反向蟹行爬行 (Crab Walk)",
    englishName: "Crab Walk",
    category: "核心",
    equipment: "自重",
    subTarget: "深层核心 (抗旋/抗伸)",
    target: "核心抗后倾、肩后侧稳定性、臀大肌",
    secondaryMuscles: ["核心协同稳定肌群"],
    aliases: ["反向蟹行爬行 (Crab Walk)","Crab Walk","蟹行","反向爬行"],
    gifUrl: "./exercises/crab-walk.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "面朝天花板双手双脚支撑倒着爬行，激活后链核心与消除含胸圆肩。",
    tags: ["自重","深层核心 (抗旋/抗伸)","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-side-bridge-pulse",
    name: "侧桥抬髋动态脉冲 (Side Bridge Pulse)",
    englishName: "Side Bridge Pulse",
    category: "核心",
    equipment: "自重",
    subTarget: "腹斜肌 (侧腹)",
    target: "腹外斜肌与腰方肌侧屈力量",
    secondaryMuscles: ["核心协同稳定肌群"],
    aliases: ["侧桥抬髋动态脉冲 (Side Bridge Pulse)","Side Bridge Pulse","侧桥抬臀","侧平板动态脉冲"],
    gifUrl: "./exercises/side-bridge.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "侧撑状态下骨盆有节奏地下沉并向上推高，彻底消除侧腹游泳圈。",
    tags: ["自重","腹斜肌 (侧腹)","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
