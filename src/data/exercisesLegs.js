export const LEG_EXERCISES = [
  ...
  },
  {
    ...
    aliases: ["深蹲", "杠铃深蹲", "高杠深蹲", "低杠深蹲", "传统深蹲", "后蹲", "三大项深蹲", "杠铃后深蹲 (Back Squat)", "杠铃后深蹲", "后深蹲", "Back Squat", "Squat"],
  ...
  },
  {
    ...
    aliases: ["保加利亚深蹲", "哑铃保加利亚分腿蹲", "哑铃保加利亚深蹲", "分腿蹲", "后脚抬高蹲", "单腿深蹲", "保加利亚", "Bulgarian Split Squat"],
    gifUrl: "./exercises/dumbbell-bulgarian-split-squat.gif",
    defaultSets: 3,
    defaultReps: "10-12",
  ...
  },
  {
    ...
    gifUrl: "./exercises/lever-side-hip-abduction.gif",
    defaultSets: 3,
    defaultReps: "12-15",
  ...
  },
  {
    ...
    gifUrl: "./exercises/hip-adduction-machine.gif",
    defaultSets: 3,
    defaultReps: "12-15",
  ...
  },
  {
    ...
    gifUrl: "./exercises/dumbbell-walking-lunge.gif",
    defaultSets: 3,
  ...
  },
  {
    ...
    gifUrl: "./exercises/dumbbell-goblet-squat.gif",
    defaultSets: 3,
    defaultReps: "12-15",
  ...
  },
  {
    ...
    name: "钟摆深蹲 (Pendulum Squat)",
    englishName: "Pendulum Squat",
    category: "腿部",
    equipment: "固定器械",
    subTarget: "股四头肌",
    target: "股四头肌全束孤立撕裂、极低腰椎压力",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["钟摆深蹲 (Pendulum Squat)","Pendulum Squat","钟摆深蹲","钟摆机深蹲"],
    gifUrl: "./exercises/pendulum-squat.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "力量馆神级器械！钟摆圆弧力线消除腰椎轴向压迫，将100%负荷完全转移至股四头肌。",
    tags: ["固定器械","股四头肌","精选变式"],
    tips: {
  ...
  {
    id: "ex-reverse-hack-squat",
    name: "反向哈克深蹲 (面壁哈克蹲)",
    englishName: "Reverse Hack Squat",
    category: "腿部",
    equipment: "固定器械",
    subTarget: "臀大/臀中肌",
    target: "臀大肌深层发力、腘绳肌上段",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["反向哈克深蹲 (面壁哈克蹲)","Reverse Hack Squat","反向哈克","面壁哈克"],
    gifUrl: "./exercises/reverse-hack-squat.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "身体面朝哈克靠垫反向站立，极大地增加了髋屈伸幅度，主攻饱满蜜桃臀。",
    tags: ["固定器械","臀大/臀中肌","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
      "peak": "向心终点充分挤压目标肌群1-2秒，感受峰值做工肌电收缩。",
  ...
  },
  {
    id: "ex-curtsy-lunge",
    name: "屈膝礼弓步 (侧后交叉箭步蹲)",
    englishName: "Curtsy Lunge",
    category: "腿部",
    equipment: "哑铃",
    subTarget: "臀大/臀中肌",
    target: "臀中肌、臀小肌、阔筋膜张肌稳定",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["屈膝礼弓步 (侧后交叉箭步蹲)","Curtsy Lunge","屈膝礼深蹲","交叉弓步","侧后弓步"],
    gifUrl: "./exercises/curtsy-squat.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "单腿向对侧后方撤步下蹲，深度拉伸外侧臀肌，填补侧臀凹陷。",
    tags: ["哑铃","臀大/臀中肌","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-pendulum-lunge",
    name: "前后钟摆箭步蹲",
    englishName: "Pendulum Lunge",
    category: "腿部",
    equipment: "自重",
    subTarget: "股四头肌",
    target: "股四头肌、臀大肌动态平衡与核心协调",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["前后钟摆箭步蹲","Pendulum Lunge","钟摆弓步","前后跨步弓步"],
    gifUrl: "./exercises/pendulum-lunge.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "前跨步紧接着不着地顺势向后跨步，兼顾前侧股四向心做工与后侧离心缓冲。",
    tags: ["自重","股四头肌","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-dumbbell-sumo-squat",
    name: "相扑高位哑铃深蹲",
    englishName: "Dumbbell Sumo Squat",
    category: "腿部",
    equipment: "哑铃",
    subTarget: "大腿内收肌",
    target: "大腿内收肌群、臀大肌内侧支撑",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["相扑高位哑铃深蹲","Dumbbell Sumo Squat","哑铃相扑深蹲","开腿深蹲"],
    gifUrl: "./exercises/dumbbell-sumo-squat.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "宽站距脚尖外展45度，双手垂直提拉哑铃，彻底消除大腿内侧松弛。",
    tags: ["哑铃","大腿内收肌","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-hack-calf-raise",
    name: "哈克深蹲机负重提踵",
    englishName: "Hack Squat Calf Raise",
    category: "腿部",
    equipment: "固定器械",
    subTarget: "小腿提踵",
    target: "小腿腓肠肌外侧与内侧头",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["哈克深蹲机负重提踵","Hack Squat Calf Raise","哈克提踵","哈克机小腿","Hack Calf Raise"],
    gifUrl: "./exercises/hack-squat-calf-raise.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "借助哈克斜板滑轨进行大重量提踵，稳定安全，冲刺小腿极限围度。",
    tags: ["固定器械","小腿提踵","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  },
  {
    ...
    name: "驴式器械提踵 (Donkey Calf Raise)",
    englishName: "Donkey Calf Raise",
    category: "腿部",
    equipment: "固定器械",
    subTarget: "小腿提踵",
    target: "小腿三头肌深层最大离心牵拉",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["驴式器械提踵 (Donkey Calf Raise)","Donkey Calf Raise","驴式提踵","弯腰提踵","Donkey Calf"],
    gifUrl: "./exercises/lever-donkey-calf-raise.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "施瓦辛格最爱的小腿动作！身体屈髋前俯90度，使腓肠肌处于最长解剖拉伸位。",
    tags: ["固定器械","小腿提踵","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  },
  {
    ...
    name: "靠墙站姿胫骨前肌提踵 (Tibialis Raise)",
    englishName: "Tibialis Raise",
    category: "腿部",
    equipment: "自重",
    subTarget: "小腿提踵",
    target: "胫骨前肌 (小腿前侧抗冲击防扭伤)",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["靠墙站姿胫骨前肌提踵 (Tibialis Raise)","Tibialis Raise","胫骨前提踵","勾脚尖练习","膝盖防伤提踵"],
    gifUrl: "./exercises/standing-dorsiflexion.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "背靠墙勾起脚尖，强化小腿前侧胫骨前肌，有效预防跑步胫骨疼痛与深蹲膝内扣。",
    tags: ["自重","小腿提踵","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  },
  {
    ...
    name: "单腿45度倒蹬腿举",
    englishName: "Single-Leg 45-Degree Leg Press",
    category: "腿部",
    equipment: "固定器械",
    subTarget: "股四头肌",
    target: "股四头肌单侧做工、纠正下肢力量不平衡",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["单腿45度倒蹬腿举","Single-Leg 45-Degree Leg Press","单腿倒蹬","单腿腿举","Single Leg Press"],
    gifUrl: "./exercises/single-leg-leg-press.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "单腿独立承重，彻底暴露弱侧腿，预防因双腿代偿引发的骨盆扭转。",
    tags: ["固定器械","股四头肌","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  },
  {
    ...
    name: "绳索跨下后拉挺髋 (Pull Through)",
    englishName: "Cable Pull-Through",
    category: "腿部",
    equipment: "绳索",
    subTarget: "臀大/臀中肌",
    target: "臀大肌顶峰锁定收缩、纯髋铰链学习",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["绳索跨下后拉挺髋 (Pull Through)","Cable Pull-Through","跨下绳索后拉","挺髋拉伸","Cable Pull Through"],
    gifUrl: "./exercises/standing-cable-pull-through.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "背对龙门架从双腿间向后拉起绳索，强制脊柱中立，最安全的臀部髋铰链动作。",
    tags: ["绳索","臀大/臀中肌","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-nordic-curl",
    name: "诺迪克腘绳肌离心降体 (Nordic Curl)",
    englishName: "Nordic Hamstring Curl",
    category: "腿部",
    equipment: "自重",
    subTarget: "腘绳肌 (后侧)",
    target: "大腿后侧腘绳肌离心制动力量",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["诺迪克腘绳肌离心降体 (Nordic Curl)","Nordic Hamstring Curl","诺迪克弯举","自重腿弯举","Nordic Curl"],
    gifUrl: "./exercises/nordic-hamstring-curl.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "国际公认预防大腿后侧拉伤的黄金动作！依靠双膝跪地对抗重力缓慢下落。",
    tags: ["自重","腘绳肌 (后侧)","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-jefferson-squat",
    name: "杰弗逊跨杠深蹲 (Jefferson Squat)",
    englishName: "Jefferson Squat",
    category: "腿部",
    equipment: "杠铃",
    subTarget: "大腿内收肌",
    target: "双腿内收肌、核心抗旋转深层肌群",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["杰弗逊跨杠深蹲 (Jefferson Squat)","Jefferson Squat","跨杠深蹲","杰弗逊深蹲"],
    gifUrl: "./exercises/jefferson-squat.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "杠铃位于双腿之间前后交叉站立深蹲，产生独特的抗扭转剪切刺激。",
    tags: ["杠铃","大腿内收肌","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-frog-pump",
    name: "仰卧青蛙脚对脚推髋 (Frog Pumps)",
    englishName: "Frog Pumps",
    category: "腿部",
    equipment: "自重",
    subTarget: "臀大/臀中肌",
    target: "臀大肌下部与外侧孤立泵感",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["仰卧青蛙脚对脚推髋 (Frog Pumps)","Frog Pumps","青蛙推髋","脚掌相对臀桥","Frog Pump"],
    gifUrl: "./exercises/frog-pump.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "双脚掌脚心相对合拢外展屈膝做臀桥，彻底消除腘绳肌代偿，纯粹榨干臀肌。",
    tags: ["自重","臀大/臀中肌","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-lateral-step-up",
    name: "哑铃侧向踏台阶上凳",
    englishName: "Lateral Step-up",
    category: "腿部",
    equipment: "哑铃",
    subTarget: "臀大/臀中肌",
    target: "臀中肌单侧三维稳定、股内侧肌",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["哑铃侧向踏台阶上凳","Lateral Step-up","侧向上凳","侧向登阶","Lateral Step Up"],
    gifUrl: "./exercises/lateral-step-up.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "侧向踏上木箱或平凳，模拟越野运动力线，强化髋关节侧向防扭力。",
    tags: ["哑铃","臀大/臀中肌","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  {
    id: "ex-barbell-hack-squat",
    name: "身后杠铃哈克深蹲 (身后硬拉深蹲)",
    englishName: "Barbell Hack Squat",
    category: "腿部",
    equipment: "杠铃",
    subTarget: "股四头肌",
    target: "股四头肌股直肌与股外侧肌孤立",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["身后杠铃哈克深蹲 (身后硬拉深蹲)","Barbell Hack Squat","背后深蹲","自由哈克深蹲","Barbell Hack"],
    gifUrl: "./exercises/barbell-hack-squats.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "将杠铃置于脚后跟后侧向上拉起，在没有哈克机时完美的自由重量替代方案。",
    tags: ["杠铃","股四头肌","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
  ...
  },
  {
    id: "ex-curt-lunge",
    name: "自重静态弓箭步下蹲",
    englishName: "Bodyweight Static Lunge",
    category: "腿部",
    equipment: "自重",
    subTarget: "股四头肌",
    target: "股四头肌、膝踝关节本体感觉",
    secondaryMuscles: ["腿部协同稳定肌群"],
    aliases: ["自重静态弓箭步下蹲","Bodyweight Static Lunge","自重弓步","静态箭步蹲","Static Lunge"],
    gifUrl: "./exercises/bodyweight-lunge.gif",
    defaultSets: 3,
    defaultReps: "10-12",
    scienceDetail: "零器械下肢力量打底动作，适合在训练尾声或居家打卡时做力竭组。",
    tags: ["自重","股四头肌","精选变式"],
    tips: {
      "prep": "调整器械至适合身高体态，脊柱保持中立，核心收紧蓄力。",
      "execution": "顺应关节解剖自然运动平面做工，主动控制负荷，避免惯性晃荡借力。",
