<template>
  <Teleport to="body">
    <div v-if="visible" 
      ...
      <div class="relative z-10 bg-zinc-900 border border-zinc-700/80 rounded-t-3xl sm:rounded-3xl w-full max-w-lg max-h-[85vh] flex flex-col shadow-2xl overflow-hidden overflow-x-hidden text-zinc-100"
...
import { store, getFullHonorProfile, performPrestigeReset, toggleDeloadShield } from "../store/fitnessStore.js";
