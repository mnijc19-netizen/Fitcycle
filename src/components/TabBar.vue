<template>
  <nav class="fixed bottom-0 left-0 right-0 z-30 transition-all duration-300 px-2 pt-1.5"
    ...
    <!-- Top fine hairline shimmer for Chamber -->
    ...
    <div class="max-w-md mx-auto grid grid-cols-5">
      ...
      <!-- ============================================== -->
      <!-- TAB 1: TODAY (今日 - Headhunter 猎头手枪) -->
      <!-- ============================================== -->
      <button @click="switchTab('today')" 
              ...
              :class="[
                store.activeTab === 'today' 
                  ? (store.settings.uiSkin === 'chamber' ? 'text-[#E5C378] font-bold -translate-y-0.5' : 'text-amber-400 font-bold scale-105') 
                  : (store.settings.uiSkin === 'chamber' ? 'text-[#5C6E8F] hover:text-[#9AA8C2]' : 'text-zinc-500 hover:text-zinc-300')
              ]">
        ...
        <!-- Chamber Active Diamond Indicator -->
      ...
      <!-- ============================================== -->
      <!-- TAB 2: CYCLE (周期 - Rendezvous 传送锚点) -->
      <!-- ============================================== -->
      ...
      <!-- ============================================== -->
      <!-- TAB 3: CALENDAR (日历 - Trademark 监控装置) -->
      <!-- ============================================== -->
      ...
      <!-- ============================================== -->
      <!-- TAB 4: EXERCISES (动作库 - Tour De Force 终极武器库) -->
      <!-- ============================================== -->
      ...
      <!-- ============================================== -->
      <!-- TAB 5: STATS & SETTINGS (统计设置 - Chamber 名片/准星) -->
      <!-- ============================================== -->
