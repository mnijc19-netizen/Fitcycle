<template>
  <Teleport to="body">
    <div v-if="visible" 
      ...
      <div class="relative z-10 bg-zinc-900 border border-zinc-700/80 rounded-t-3xl sm:rounded-3xl max-w-lg w-full max-h-[85vh] flex flex-col shadow-2xl overflow-hidden overflow-x-hidden animate-in slide-in-from-bottom duration-200"
